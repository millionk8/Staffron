User.seed(:id,
   { id: 1, email: 'jeffrey.atto@concise.com', password: '0umah12QW', confirmed_at: Time.current, master: true, admin: true, company_id: 1, locale: 'en_US' },
   ...
   { id: 6, email: 'employee2@kriskhoury.com', password: 'password', confirmed_at: Time.current, master: false, admin: false, company_id: 1, locale: 'en_US' },
)