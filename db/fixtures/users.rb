User.seed(:id,
   { id: 1, email: 'kris@concise.com', password: 'password', confirmed_at: Time.current, master: true, admin: true, company_id: 1, locale: 'en_US' },
...
Profile.seed(:id,
   { id: 1, user_id: 1, first_name: 'Kris', last_name: 'Khoury' },
